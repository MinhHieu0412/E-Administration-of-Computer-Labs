...
namespace E_Administration.Areas.Admin.Controllers
{
    ...
    public class EditProfileController : Controller
    {
        ...
        public EditProfileController(DemoDbContext context, IWebHostEnvironment webHostEnvironment)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(E_Administration.Models.User model)
        {
